...
// MARK: - Variable Blur View (SwiftUI)
public struct VariableBlurView: UIViewRepresentable {
    ...
    /// Setting `startOffset` to a small negative coefficient (e.g. -0.1) will start blur from larger radius value.
...
// MARK: - Variable Blur UIView
/// Credit: https://github.com/nikstar/VariableBlur and https://github.com/jtrivedi/VariableBlurView
open class VariableBlurUIView: UIVisualEffectView {
    ...
    private func makeGradientImage(width: CGFloat = 100, height: CGFloat = 100, startOffset: CGFloat, direction: VariableBlurDirection) -> CGImage {
        // Use smoothLinearGradient for a smoother transition
...
/// A convenience wrapper that provides a tint-free gradient blur effect.
/// Blur is strongest at the top and fades to clear at the bottom.
public struct TintFreeGradientBlur: View {
